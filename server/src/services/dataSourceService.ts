...
export async function fetchAmazonBestSellers(): Promise<ProductDataSource[]> {
  const mockData: ProductDataSource[] = [
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} ${PRODUCT_DESCRIPTIONS[randomInt(0, PRODUCT_DESCRIPTIONS.length - 1)]} Automatic Cat Litter Box`,
      ...
      image_url: 'https://example.com/cat-litter-box-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
      supplier_price: randomFloat(40, 100),
      shipping_cost: randomFloat(8, 20),
      source: 'amazon',
      source_url: 'https://amazon.com/dp/B0014DNJQI' + Date.now()
    },
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Smart Pet Feeder with Camera`,
      ...
      image_url: 'https://example.com/pet-feeder-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
      supplier_price: randomFloat(30, 70),
      shipping_cost: randomFloat(5, 15),
      source: 'amazon',
      source_url: 'https://amazon.com/dp/B08XYZ123' + Date.now()
    },
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} ${PRODUCT_DESCRIPTIONS[randomInt(0, PRODUCT_DESCRIPTIONS.length - 1)]} Flower Fountain for Pets`,
      ...
      image_url: 'https://example.com/water-fountain-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
      supplier_price: randomFloat(10, 25),
      shipping_cost: randomFloat(3, 8),
      source: 'amazon',
      source_url: 'https://amazon.com/dp/B00VCWNJUI' + Date.now()
    },
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Dog Camera with Treat Dispenser`,
      ...
      image_url: 'https://example.com/furbo-camera-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
      supplier_price: randomFloat(45, 85),
      shipping_cost: randomFloat(8, 18),
      source: 'amazon',
      source_url: 'https://amazon.com/dp/B075WN7Y9M' + Date.now()
    },
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} GO Explore GPS Pet Tracker`,
      ...
      image_url: 'https://example.com/gps-tracker-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
      supplier_price: randomFloat(25, 60),
      shipping_cost: randomFloat(4, 10),
      source: 'amazon',
      source_url: 'https://amazon.com/dp/B07N7XZZZZ' + Date.now()
    }
  ];
...
export async function fetchAliExpressHot(): Promise<ProductDataSource[]> {
  const mockData: ProductDataSource[] = [
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} ${PRODUCT_DESCRIPTIONS[randomInt(0, PRODUCT_DESCRIPTIONS.length - 1)]} Smart Automatic Pet Feeder 5L`,
      price: randomFloat(20, 80),
      sales_volume: randomInt(15000, 50000),
      rating: randomFloat(4.2, 4.8),
      review_count: randomInt(5000, 20000),
      category: 'Pet Feeders',
      image_url: 'https://example.com/ae-feeder-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
      supplier_price: randomFloat(8, 30),
      shipping_cost: randomFloat(1, 5),
      source: 'aliexpress',
      source_url: 'https://aliexpress.com/item/' + Date.now() + randomInt(1000, 9999)
    },
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Electric Cat Toys Automatic Rotating Ball`,
      price: randomFloat(5, 25),
      sales_volume: randomInt(30000, 80000),
      rating: randomFloat(4.0, 4.6),
      review_count: randomInt(10000, 40000),
      category: 'Cat Toys',
      image_url: 'https://example.com/cat-toy-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
    ...
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Pet Grooming Vacuum Suction Brush`,
      price: randomFloat(15, 60),
      sales_volume: randomInt(10000, 30000),
      rating: randomFloat(4.1, 4.7),
      review_count: randomInt(3000, 15000),
      category: 'Pet Grooming',
      image_url: 'https://example.com/grooming-vacuum-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
    ...
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Smart Water Dispenser for Pets`,
      price: randomFloat(12, 40),
      sales_volume: randomInt(20000, 45000),
      rating: randomFloat(4.3, 4.8),
      review_count: randomInt(6000, 25000),
      category: 'Pet Water Fountains',
      image_url: 'https://example.com/water-dispenser-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
...
export async function fetch1688Supply(): Promise<ProductDataSource[]> {
  ...
  const mockData: ProductDataSource[] = chineseProducts.map((p, i) => ({
    ...
    category: p.category,
    image_url: 'https://example.com/1688-product-' + Date.now() + '-' + i + '.jpg',
    supplier_price: randomFloat(5, 100),
    shipping_cost: randomFloat(2, 20),
    source: '1688',
    source_url: 'https://1688.com/item/' + Date.now() + '-' + Math.random().toString(36).substr(2, 6)
  }));
...
export async function fetchTikTokShopTrending(): Promise<ProductDataSource[]> {
  const mockData: ProductDataSource[] = [
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Viral Cat Toy Ball - Smart Interactive`,
      price: randomFloat(8, 35),
      sales_volume: randomInt(50000, 150000),
      rating: randomFloat(4.4, 4.9),
      review_count: randomInt(15000, 60000),
      category: 'Pet Toys',
      image_url: 'https://example.com/tiktok-cat-toy-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
      supplier_price: randomFloat(2, 10),
      shipping_cost: randomFloat(0.5, 4),
      source: 'tiktok',
      source_url: 'https://shop.tiktok.com/item/' + Date.now() + '-' + randomInt(100, 999)
    },
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Pet Hair Remover Roller - TikTok Viral`,
      price: randomFloat(5, 25),
      sales_volume: randomInt(80000, 200000),
      rating: randomFloat(4.2, 4.8),
      review_count: randomInt(30000, 80000),
      category: 'Pet Grooming',
      image_url: 'https://example.com/tiktok-hair-remover-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
    ...
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Cat Scratcher Lounge Bed - Modern Design`,
      price: randomFloat(20, 70),
      sales_volume: randomInt(20000, 60000),
      rating: randomFloat(4.3, 4.8),
      review_count: randomInt(5000, 20000),
      category: 'Cat Furniture',
      image_url: 'https://example.com/tiktok-scratcher-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
    ...
    {
      title: `${BRANDS[randomInt(0, BRANDS.length - 1)]} Portable Pet Water Bottle - Travel Essential`,
      price: randomFloat(10, 30),
      sales_volume: randomInt(40000, 100000),
      rating: randomFloat(4.1, 4.7),
      review_count: randomInt(10000, 40000),
      category: 'Pet Travel',
      image_url: 'https://example.com/tiktok-water-bottle-' + Date.now() + '-' + randomInt(1, 99) + '.jpg',
